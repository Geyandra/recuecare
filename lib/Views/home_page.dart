              ...
              children: [
                        ...
                        children: [
                          ...
                          const SizedBox(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.black, overflow: TextOverflow.clip),
                            ),
                          ),
                        ],
                      ),
                ...
                Row(
                  ...
                  children: [
                    InkWell(
                      onTap: () {
                        Navigator.push(context, createRoute(const EdukasiPage()));
                      },
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(context, createRoute(const PanduanPage()));
                      },
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
