          ...
          case ViewState.none:
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  onTap: () {
                    Navigator.push(context, createRoute(AdminPengaduanPage(dataPengaduan: value.getDataPengaduan[index],)));
                  },
                  child: Card(
                    child: Container(
                      ...
                      child: ListTile(
                        ...
                        trailing: Image.network(value.getDataPengaduan[index].buktiFoto),
                      ),
                    ),
                  ),
                );
